...
2. Чтобы увидеть все ветвления и историю слияния веток нужно ввести команду:

        git log --all --oneline --graph

### Слияние веток

Чтобы слить две ветки нужно перейти в ветку  куда будет проводиться слияние и ввести коменду :

        git merge <имя вливаемой ветки>

### Конфликт слияния и его разрешение

Если в разных ветках в одинаковых строках различная информация, то при слиянии происходит конфликт. Нужно вручную внести изменения и сделать коммит. В программе VSCode,  вы можете выбрать какое изменение внести и сохранить (текущее, входящее, оба или внести изменеия вручную).
